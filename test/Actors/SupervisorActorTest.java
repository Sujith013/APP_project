...
public class SupervisorActorTest {
    ...
    public void testGetSearchSource() {
        ...
        UserActor.SearchData mockResponse = new UserActor.SearchData(expectedVideos);
