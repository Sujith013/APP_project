...
// Count happy and sad words/emojis/emoticons in each description
    ...
    /**
     * @return The value of the total happy words/emojis/emoticons in the description
     */
    ...
    /**
     * @return The value of the total sad words/emojis/emoticons in the description
     */
    ...
    /**
     * @return The value of the total happy words in the description
     */
    ...
    /**
     * @return The value of the total sad words in the description
     */
    ...
    /**
     * @return The value of the total happy emojis in the description
     */
    public List<String> getHappyEmojis() {
        return this.happyEmojis;
    }


    /**
     * @return The value of the total sad emojis in the description
     */
    public List<String> getSadEmojis() {
        return this.sadEmojis;
    }


    /**
     * @return The value of the total happy emoticons in the description
     */
    public List<String> getHappyEmoticons() {
        return this.happyEmoticons;
    }


    /**
     * @return The value of the total sad emoticons in the description
     */
